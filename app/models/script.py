...
class Scene(BaseModel):
    ...
    narration: str = Field(..., min_length=10, max_length=500, description="Spoken voiceover narration")
    visual_type: str = Field(..., min_length=3, max_length=50, description="Visual scene template identifier")
    key_takeaway: str = Field(..., min_length=3, max_length=150, description="On-screen bullet / takeaway")
...
class VideoScript(BaseModel):
    ...
    overview: str = Field(..., min_length=10, max_length=300, description="Brief educational summary")
    scenes: List[Scene] = Field(..., min_length=2, max_length=10, description="Ordered list of scenes")
